// jasmine matches : https://github.com/JamieMason/Jasmine-Matchers
context = describe;
...
describe("the JavaScript language", function(){
  ...
  describe("has different types and operators that", function(){
    ...
    it("surprises me, NaN is not comparable with NaN", function(){
        ...
        expect(typeof(NaN)).toEqual("number"); // NaN = numeric type
    ...
    it("knows the type of a function", function(){
        ...
        expect(typeof(xxx)).toBe('undefined'); //typeof devuelve un string con el tipo
    });
    ...
    it("may contain functions inside arrays", function(){
        ...
        expect(arr[2](1)).toEqual(4);//arg === 1, (3+1)===4
    });
    ...
    it("concatenate arrays - well, kind of", function(){
        ...
        expect(a + b).toEqual('1,2,34,5,6');//devuelve un string concatenando el ultimo elemento con el primero dle siguiente
    });
    ...
    it("joins arrays and other things", function(){
        ...
        expect(true + a).toEqual("true1,2,3");// WTF??
    });
    ...
    it("can't compare arrays", function(){
        ...
        expect(a == b).toBeFalsy();  // no son iguales al no  apuntar a la misma posición de memoria
  ...
  describe("considers functions as first class citizens", function(){
    ...
    it("may return arrays that contains functions and so on", function(){
        function example(){
           return[function(something){ return [something,10] }];
        }
    ...
    it("matters, the declaration order when they are anonymous", function(){
        ...
        expect(exampleA()).toEqual(1);//si esta sentencia se ejecuta antes de declarar exampleB, dara como error que no se ha definido B
    });
    ...
    it("can create closures with free variables", function(){
        ...
        expect(external()).toBe(2);//devolvemos la llamada a internal
    });
    ...
    it("can create closures with several free variables", function(){
        function external(){
          ...
          //return internal(); para devolver valores en la llamda principal, en caso contrario es undefined(no devuelve nada)
        }
    ...
    it("may return arrays that contains closures and so on", function(){
        function example(){
          return[function(something){ return [something,9+something] }];
        }
    ...
    it("passes primitive types as values (a copy) to functions", function(){
        ...
        example(x) //aqui se envia a exmple x pero solo se hace el expect del x original
        expect(x).toEqual(1);
    ...
    it("can return closures as a function result", function(){
        ...
        expect(f(3)).toBe(8); //==> plus(5)(3)dentro de la funcion plus que tiene asignado como amount 5, le pasamos el segundo(3) valor a la funcion interior
    });
    ...
    it("can have functions that receive other functions as arguments", function(){
        ...
        function example(arg){
             return arg(2,2) + 1; //=>return add(2,2)+1
        }
    ...
    it("may have functions as the input and the output", function(){
        function plus(originalFunction){
          return function(arg1){
               return originalFunction() + arg1; //=> return 1 + 2
          };
        }
    ...
    it("can invoke functions indirectly using the special 'call'", function(){
        ...
        expect(f.call(f,1,1)).toEqual(2); //el segundo f hace referencia al this dentro de la funcion
    });
  ...
  describe("has multiple ways to define and create objects", function(){
    ...
    it("may define complex objects", function(){
        var user = { address:{ street: 'sesame', city: 'chucheland'}, friends: [{ name: "triki", secondName: "monster"}]
            };
